...
abstract contract EIP3009 is AbstractStableCoinV1, EIP712Domain {
     ...
     * @param validBefore   The time before which this is valid (unix time)
     * @param nonce         Unique nonce
     * @param signature     Signature byte array associated with authorization
     */
    function _transferWithAuthorization(
        address from,
        address to,
    ...
    /**
     * @notice Execute a receive with a signed authorization
     * @param from          Payer's address (Authorizer)
     * @param to            Payee's address
     * @param value         Amount to be transferred
     * @param validAfter    The time after which this is valid (unix time)
    ...
    function _requireUnusedAuthorization(
        ...
        require(
            ...
            "StableCoinV1: authorization is used or canceled"
        );
    }
